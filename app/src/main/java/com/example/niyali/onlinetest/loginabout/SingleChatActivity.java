        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!"".equals(inputText)){
                    ...
                    msgList.add(msg);
                    editor.putInt(sdf.format(new Date())+"@"+inputText+"@"+teacherName,Msg.TYPE_SEND);
                    editor.commit();
    ...
    public class ChatMessageReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(intent.getAction().equals(PushConstants.ACTION_MESSAGE)){
                ...
                Toast.makeText(SingleChatActivity.this,intent.getStringExtra("msg"),Toast.LENGTH_LONG).show();
                ...
                editor.putInt(sdf.format(new Date())+"@"+msgContext+"@"+teacherName,Msg.TYPE_RECEIVED);
                editor.commit();
